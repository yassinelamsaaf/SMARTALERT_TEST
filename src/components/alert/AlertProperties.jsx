...
const AlertProperties = ({ alerts = [], deleteMode = false, selected = [], setSelected }) => {
  ...
  return (
    <>
      {alerts.length === 0 ? (
        <div className="text-center text-light-1 py-40 w-100" style={{justifyContent: "center", alignItems: "center", display: "flex"}}>
          <img src="public/img/pages/alerts/no-result-found.png" alt="No alert found" />
        </div>
      ) : (
